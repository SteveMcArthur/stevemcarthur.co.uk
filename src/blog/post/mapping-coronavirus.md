...
This will put a map in your html element with the id of "map". The first parameter of `setView` is the lat/long of the centre of the map, the second the zoom. `[20,0],2` will give you a world map view.
